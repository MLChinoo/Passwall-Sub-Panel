...
func TestKVSettingsRoundtrip(t *testing.T) {
	...
	in := ports.UISettings{
		...
		TrafficSnapshotRetentionDays: 200,
	...
	checks := []struct {
		...
		{"TrafficSnapshotRetentionDays", out.TrafficSnapshotRetentionDays, in.TrafficSnapshotRetentionDays},
...
func TestKVSettingsDefaultsOnEmpty(t *testing.T) {
	...
	mustNonZero := map[string]int{
		...
		"TrafficSnapshotRetentionDays": out.TrafficSnapshotRetentionDays,
