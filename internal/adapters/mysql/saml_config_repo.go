...
func (r *samlConfigRow) toDomain() *config.SAMLConfig {
	c := &config.SAMLConfig{
		Enabled: r.Enabled,
		Mode:    r.Mode,
		SP: config.SPConf{
...
func samlConfigFromDomain(c *config.SAMLConfig) *samlConfigRow {
